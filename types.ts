...
export interface Student {
  ...
  siblingId?: string; // ID del hermano vinculado (para compatibilidad)
  siblingName?: string; // Nombre del hermano vinculado (para compatibilidad)
  siblingIds?: string[]; // IDs de todos los hermanos vinculados
...
export type ViewState = 'LANDING' | 'DASHBOARD' | 'ATTENDANCE' | 'STUDENTS' | 'TOOLS' | 'BEHAVIOR' | 'ACTIVITIES' | 'HOMEWORK_QR' | 'FINANCE' | 'DOCUMENTS' | 'SETTINGS' | 'PARENTS_PORTAL' | 'COMMUNICATIONS' | 'DIRECTOR' | 'USAER' | 'LIBRARY' | 'LITERACY' | 'EXAM_GENERATOR' | 'CTE_GAMES' | 'EARLY_WARNING';
